...
class ARROW_EXPORT Hashing32 {
 ...
 private:
  ...
  static inline uint32_t combine_accumulators(uint32_t acc1, uint32_t acc2, uint32_t acc3,
                                              uint32_t acc4);
  static inline uint32_t combine_hashes_imp(uint32_t previous_hash, uint32_t hash) {
  ...
  static inline __m256i combine_hashes_imp_avx2(__m256i previous_hash, __m256i hash);
  template <bool T_COMBINE_HASHES>
...
class ARROW_EXPORT Hashing64 {
 ...
 private:
  ...
  static inline uint64_t combine_accumulators(uint64_t acc1, uint64_t acc2, uint64_t acc3,
                                              uint64_t acc4);
  static inline uint64_t combine_hashes_imp(uint64_t previous_hash, uint64_t hash) {
  ...
  static void hash_bit_imp(int64_t bit_offset, uint32_t num_keys, const uint8_t* keys,
                           uint64_t* hashes);
  static void hash_bit(bool T_COMBINE_HASHES, int64_t bit_offset, uint32_t num_keys,
                       const uint8_t* keys, uint64_t* hashes);
  template <bool T_COMBINE_HASHES, typename T>
  static void hash_int_imp(uint32_t num_keys, const T* keys, uint64_t* hashes);
  static void hash_int(bool T_COMBINE_HASHES, uint32_t num_keys, uint64_t length_key,
                       const uint8_t* keys, uint64_t* hashes);
};
