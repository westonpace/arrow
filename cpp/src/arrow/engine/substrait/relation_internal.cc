...
Result<DeclarationInfo> FromProto(const substrait::Rel& rel, const ExtensionSet& ext_set,
  ...
  switch (rel.rel_type_case()) {
    ...
    case substrait::Rel::RelTypeCase::kExtensionLeaf: {
      ...
      ARROW_ASSIGN_OR_RAISE(
          auto ext_leaf_decl,
          conversion_options.extension_provider->HandleLeaf(ext.detail()));
    ...
    case substrait::Rel::RelTypeCase::kExtensionSingle: {
      ...
      ARROW_ASSIGN_OR_RAISE(
          ...
          conversion_options.extension_provider->HandleSingle(input, ext.detail()));
    ...
    case substrait::Rel::RelTypeCase::kExtensionMulti: {
      ...
      ARROW_ASSIGN_OR_RAISE(
          auto ext_multi_decl,
          conversion_options.extension_provider->HandleMulti(inputs, ext.detail()));
